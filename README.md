...
| :-------------------------: | ---------------------------------------------------------------------------- | :----------------------------------------------------------------------------: | :-------------------------------------: |
| Abdul hannan |    Criação do documento Guia.md para detalhar e explicar melhor todos os módulos e funções do projeto e criacao do bot de toma decisões basedo nas probabilidades, escolhendo células com menor risco (<0.3) e usa BFS para explorar células| Excelente   | [Link para todos os commits](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commits/main/?author=hannanhunny01) |
...
|       Deivid Carvalho       |  Gerei uma estrutura nova para garantir o ciclo de estados de inicio do jogo, possibilitando a criação do botão de reiniciar. Além disso, implementei também um cronômetro que atualiza independentemente dos turnos do jogo. | Boa | [Geração do botão de reiniciar e cronômetro](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/1f0ca4013cd0fb147bdda01b3a142405910878b7) |
| Felipe de Jesus Rodrigues |  Geração de bombas aleátoria para cada dificuldade e tamanho de tabuleiro. Tela de seleção de dificuldade. Contagem de bandeiras na tela.  |  Excelente  | [Geração de bombas aleátoria para cada dificuldade e tamanho de tabuleiro](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/8d3282f7ae9a6ec657430fa2202ea882dfea59fd); [Tela de seleção de dificuldade](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/96f9fb93655bc39be974079a1527b9b75176fa8c); [Contagem de bandeiras na tela](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/7379f73b10d3de1a7dda46cf0fa40be5b8065252) |
...
| Pedro fonseca Cruz          |  Sem contribuições  |  Nulo   |  Sem commits   |
| Rafael Brito Bosi Rodrigues | Implementação da DFS para busca dos nós por meio de uma estrutura de pilha, implementação das telas de seleção de estrutura e tamanho de grid | Excelente |  [Adicionando tela de tamanho de grid](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/2dc404706ade9381073bbcaab5b31ec6b4dcccd1)<br>[Adicionando opção de estrutura de pilha](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/6adef3884914a3cd77b3cd1539e486ee11b9b00b)<br>[Ajustando os botões e tamanho de tela](https://github.com/UnBParadigmas2024-2/2024.2_G4_Funcional_CampoMinado/commit/74e39b3b9ba5a51f1d1e8d2266cfd01e52ced112)|
